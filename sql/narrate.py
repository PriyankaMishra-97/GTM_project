...
class ResultRenderer:
    ...
    def narrate(self, question: str, sql: str, result: QueryResult) -> str:
        ...
        return safety.filter_response(self.client.chat(prompts.NARRATE_SYSTEM, user))
    ...
    def render(
        ...
        context = f"{question}\n{sql}"
        text = self.narrate(question, sql, result)
        ...
        text2 = safety.filter_response(self.client.chat(prompts.NARRATE_SYSTEM, retry_user))
